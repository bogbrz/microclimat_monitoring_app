          ...
          providers: [
            BlocProvider(
              create: (context) => TempDataCubit(
                TempRepository(TempDataSource())..getTempDataModel4(),
              ),
            ),
            BlocProvider(
              create: (context) => HumidityDataCubit(
                HumidityRepository(HumidityDataSource())
                  ..getHumidityDataModel4(),
              ),
            ),
            BlocProvider(
              create: (context) => NoiseDataCubit(
                  NoiseRepository(NoiseDataSource())..getNoiseDataModel4()),
            ),
          ],
                          ...
                          Padding(
                            ...
                            child: Row(
                                ...
                                children: [
                                  InkWell(
                                    onTap: () {
                                      context.read<TempDataCubit>().tempData4();
