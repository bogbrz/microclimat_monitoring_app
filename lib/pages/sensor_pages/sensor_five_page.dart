          ...
          providers: [
            BlocProvider(
              create: (context) => TempDataCubit(
                TempRepository(TempDataSource())..getTempDataModel5(),
              ),
            ),
            BlocProvider(
              create: (context) => HumidityDataCubit(
                HumidityRepository(HumidityDataSource())
                  ..getHumidityDataModel5(),
              ),
            ),
            BlocProvider(
              create: (context) => NoiseDataCubit(
                  NoiseRepository(NoiseDataSource())..getNoiseDataModel5()),
            ),
          ],
                          ...
                          Padding(
                            ...
                            child: Row(
                                ...
                                children: [
                                  InkWell(
                                    onTap: () {
                                      context.read<TempDataCubit>().tempData5();
