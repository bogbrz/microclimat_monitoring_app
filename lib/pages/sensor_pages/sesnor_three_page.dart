          ...
          providers: [
            BlocProvider(
              create: (context) => TempDataCubit(
                TempRepository(TempDataSource())..getTempDataModel3(),
              ),
            ),
            BlocProvider(
              create: (context) => HumidityDataCubit(
                HumidityRepository(HumidityDataSource())
                  ..getHumidityDataModel3(),
              ),
            ),
            BlocProvider(
              create: (context) => NoiseDataCubit(
                  NoiseRepository(NoiseDataSource())..getNoiseDataModel3()),
            ),
          ],
                          ...
                          Padding(
                            ...
                            child: Row(
                                ...
                                children: [
                                  InkWell(
                                    onTap: () {
                                      context.read<TempDataCubit>().tempData3();
