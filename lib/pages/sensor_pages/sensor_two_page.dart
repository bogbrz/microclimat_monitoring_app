          ...
          providers: [
            BlocProvider(
              create: (context) => TempDataCubit(
                TempRepository(TempDataSource())..getTempDataModel2(),
              ),
            ),
            BlocProvider(
              create: (context) => HumidityDataCubit(
                HumidityRepository(HumidityDataSource())
                  ..getHumidityDataModel2(),
              ),
            ),
            BlocProvider(
              create: (context) => NoiseDataCubit(
                  NoiseRepository(NoiseDataSource())..getNoiseDataModel2()),
            ),
          ],
                          ...
                          Padding(
                            ...
                            child: Row(
                                ...
                                children: [
                                  InkWell(
                                    onTap: () {
                                      context.read<TempDataCubit>().tempData2();
